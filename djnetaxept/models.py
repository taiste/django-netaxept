...
from djnetaxept.managers import NetaxeptPaymentManager, NetaxeptRecurringPaymentManager, NetaxeptTransactionManager
...
class NetaxeptPayment(models.Model):
    ...
    responsecode = models.CharField(max_length=16, null=True, blank=True)
...
class NetaxeptRecurringPayment(NetaxeptPayment):
    ...
    objects = NetaxeptRecurringPaymentManager()
